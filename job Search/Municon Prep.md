...
- Eric Rojo (Full Stack Software Developer)
	- About from LinkedIn: has the same first line for about as Kelvin
...
Current:
- I recently graduated from UBC and am working on freelance projects, most recent one being the client management platform for a wealth mangement firm in calgary. I built a platform for them to move away from the workflow they were using where 
Past
Future
Outside of work
...
|**2. Work with real-time data and interconnected systems**|**Tell me about a time you had to integrate multiple systems, services, sensors, or pieces of hardware. What made it difficult?**|
|**3. Solve ambiguous technical problems independently**|**Tell me about a time you were given a problem without a clear solution and had to figure out the approach yourself.**|
|**4. Improve or scale an existing application**|**Tell me about a time you improved the performance, reliability, scalability, or maintainability of an existing system.**|
|**5. Make good software architecture/design decisions**|**Tell me about a time you had to make an important architectural or design decision. What alternatives did you consider?**|
